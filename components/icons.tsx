...
export const BanknotesIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-4 h-4"}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 18.75a60.07 60.07 0 0 1 15.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5v.75A.75.75 0 0 1 3 6h-.75m0 0v-.375c0-.621.504-1.125 1.125-1.125H20.25M2.25 6v9m18-10.5v.75c0 .414.336.75.75.75h.75m-1.5-1.5h.375c.621 0 1.125.504 1.125 1.125v9.75c0 .621-.504 1.125-1.125-1.125h-15c-.621 0-1.125-.504-1.125-1.125V8.25m18-3.75v.75m0-1.5v-1.5m-18 0L2.25 6m18 0L20.25 6m0 0A2.25 2.25 0 0 1 18 8.25v6a2.25 2.25 0 0 1-2.25 2.25H6.75A2.25 2.25 0 0 1 4.5 14.25v-6a2.25 2.25 0 0 1 2.25-2.25h11.25m0 0A2.25 2.25 0 0 0 18 6m-1.5-1.5h.75A2.25 2.25 0 0 1 21 6.75v9A2.25 2.25 0 0 1 18.75 18h-1.5m-1.5-1.5h.375c.621 0 1.125.504 1.125 1.125v.375m-1.5-1.5V18a2.25 2.25 0 0 1-2.25 2.25H6.75a2.25 2.25 0 0 1-2.25-2.25V6.75m18 0c0-.621-.504-1.125-1.125-1.125H6.75M6 12h9" />
    </svg>
);
  
export const BuildingOffice2Icon = ({ className }: { className?: string }) => (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-4 h-4"}>
          <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 21h16.5M4.5 3h15M5.25 3v18m13.5-18v18M9 6.75h6M9 11.25h6M9 15.75h6M4.5 21V3m0 18h-1.5" />
      </svg>
);
